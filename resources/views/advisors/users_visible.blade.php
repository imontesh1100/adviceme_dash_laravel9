...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Advisors Visible</h4>
...
<div class="table-responsive mb-4">
    <table id="datatable-custom" class="table align-middle datatable dt-responsive table-check nowrap" style="border-collapse: collapse; border-spacing: 0 8px; width: 100%;">
        <thead>
            ...
            <th style="width: 80px; min-width: 80px;">Disable</th>
            </tr>
        </thead>
        <tbody>
            @foreach($advisorsVisibles as $a)
            <tr>
                <th scope="row">
                    <div class="form-check font-size-16">
        ...
        <div class="dataTables_paginate paging_simple_numbers" id="datatable-custom_paginate">
            <ul class="pagination">
                <li class="paginate_button page-item previous @if($page<=1) disabled @endif" id="datatable-custom_previous">
                    <a href="{{route('advisors.visible',['page'=>$page-1])}}" aria-controls="datatable-buttons" data-dt-idx="0" tabindex="0" class="page-link">Previous</a>
                </li>
                ...
                <li class="paginate_button page-item next @if($page==$lastPage) disabled @endif" id="datatable-custom_next">
                    <a href="{{route('advisors.visible',['page'=>$page+1])}}" aria-controls="datatable-custom" data-dt-idx="2" tabindex="0" class="page-link">Next</a>
                </li>
            </ul>
        </div>
    </div>
