...
<head>
    ...
    <!-- ion Range Slider -->
    <link type="text/css" href="/old/assets/css/ion-rangeslider.css" rel="stylesheet">
    <link type="text/css" href="//cdn.datatables.net/1.10.22/css/jquery.dataTables.min.css" rel="stylesheet">
...
<body class="layout-sticky-subnav layout-default">
            ...
            <div class="page-section">
                    <div class="container page__container">
                        <div class="page-separator">
                            <div class="page-separator__text">Usuarios</div>
                        </div>
                            ...
                            <div class="card-footer p-8pt">
                                <ul class="pagination justify-content-start pagination-xsm m-0">
                                    <li class="page-item @if($response['current_page']==1) disabled @endif">
                                        <a class="page-link" href="/pre-registro/usuarios?page=1">
                                            <span>First</span>
                                        </a>
                                    </li>
                                    <li class="page-item @if(is_null($response['prev_page_url'])) disabled @endif">
                                        <a class="page-link" href="/pre-registro/usuarios?page={{$response['current_page']-1}}" aria-label="Previous">
                                    ...
                                    <li class="page-item">
                                        <a class="page-link" href="/pre-registro/usuarios?page={{$response['current_page']-1}}">
                                            <span>{{$response['current_page']-1}}</span>
                                        </a>
                                    </li>
                                    @endif
                                    <li class="page-item active">
                                        <a class="page-link" href="/pre-registro/usuarios?page={{$response['current_page']}}">
                                    ...
                                    <li class="page-item @if(is_null($response['next_page_url'])) disabled @endif">
                                        <a class="page-link" href="/pre-registro/usuarios?page={{$response['current_page']+1}}" aria-label="Next">
                                            <span>Next</span>
                                            <span aria-hidden="true" class="material-icons">chevron_right</span>
                                        </a>
                                    </li>
                                    <li class="page-item @if($response['last_page']==$response['current_page']) disabled @endif">
                                        <a class="page-link" href="/pre-registro/usuarios?page={{$response['last_page']}}">
                                            <span>Last</span>
                                        </a>
                                    </li>
                                </ul>
    ...
    <script src="/old/assets/js/custom/pre-usuarios.js"></script>
